            ...
            <div className="grid grid-flow-row lg:grid-cols-2 lg:grid-flow-col gap-5 justify-center items-start">
                <div className="flex flex-col gap-y-4 text-lg">
                    ...
                    <div>
                        ...
                        <span className="primary-text"> Watumull Institute</span> and gained practical experience
                        through internships, crafting user-friendly mobile apps and responsive websites.
                    </div>
                    <div>
                        With a passion for technology and a commitment to excellence, I'm eager to contribute my skills
                        to a dynamic team like yours. Let's connect and create something amazing together!
                    </div>
                </div>
                <div className="flex flex-col gap-y-4">
                    ...
                    <div>
                        {skills.map((val, i) =>
                            val.content.map((skill) => (
                                <SkillItem skill={skill} color={val.color} borderColor={val.borderColor} />
                            ))
                        )}
                    </div>
                </div>
